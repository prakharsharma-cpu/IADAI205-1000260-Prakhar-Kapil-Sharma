...
export function ItineraryGenerator() {
  ...
  const downloadPDF = async () => {
    ...
    pdf.save('Cultural_AI_Itinerary.pdf');
  };
      ...
      {itinerary.length > 0 && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="flex justify-between items-center mb-6">
            ...
            <button 
              onClick={downloadPDF}
              className="px-4 py-3 bg-[#242731] hover:bg-[#2a2d39] text-white rounded-xl font-medium transition-colors flex items-center space-x-2 border border-[#2a2d39]"
            >
              <Download size={18} />
