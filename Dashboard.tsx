    ...
    <div className="flex gap-8 h-full">
      ...
      <div className="w-80 flex flex-col space-y-8">
        ...
        <div className="bg-[#242731] rounded-3xl p-6 shadow-xl border border-[#2a2d39]">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider">MARCH 2026</h3>
          ...
          <div className="grid grid-cols-7 gap-y-3 text-center text-sm text-white">
            ...
            <div className="bg-[#d4f870] text-[#1a1c23] rounded-full w-7 h-7 flex items-center justify-center mx-auto font-bold shadow-lg shadow-[#d4f870]/20">11</div>
            <div>12</div><div>13</div><div>14</div>
            <div>15</div><div>16</div><div>17</div><div>18</div><div>19</div><div>20</div><div>21</div>
            <div className="relative">
              22
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1 h-1 bg-[#ff6b6b] rounded-full"></span>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-[#242731] to-[#2a2d39] rounded-2xl p-4 flex items-center space-x-4 border border-[#2a2d39] hover:border-[#d4f870]/30 transition-all cursor-pointer group">
                  <div className="relative">
                    <img src="https://images.unsplash.com/photo-1548013146-72479768bada?auto=format&fit=crop&w=100&q=80" alt="Taj Mahal" className="w-16 h-16 rounded-xl object-cover" />
                    <div className="absolute -top-2 -right-2 bg-[#ff6b6b] text-white text-[10px] font-bold px-2 py-0.5 rounded-full">HOT</div>
                  </div>
                  <div className="flex-1">
                    <h5 className="text-white font-bold group-hover:text-[#d4f870] transition-colors">Agra, India</h5>
                ...
                <div className="bg-[#242731] rounded-2xl p-4 flex items-center space-x-4 border border-[#2a2d39] opacity-60 hover:opacity-100 transition-opacity cursor-pointer">
                  <img src="https://images.unsplash.com/photo-1506461883276-594a12b11cf3?auto=format&fit=crop&w=100&q=80" alt="Kyoto" className="w-16 h-16 rounded-xl object-cover" />
                  <div>
                    <h5 className="text-white font-bold">Kyoto, Japan</h5>
                    <div className="flex items-center text-gray-400 text-xs mt-1">
                      <CalendarIcon size={12} className="mr-1 text-blue-400" />
                      12 Apr - 18 Apr
                    </div>
                  </div>
                </div>
